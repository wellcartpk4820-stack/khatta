...
export function loginPage(
  ...
  <div class="min-h-screen flex items-center justify-center px-4"
    ...
    <div class="w-full max-w-sm animate-up">
      ...
      <!-- Card -->
      <div class="card p-8">
        <h2 class="text-lg font-bold text-center mb-6 text-muted uppercase tracking-widest text-xs">
          Admin Access
        </h2>
        ...
        ${setupSuccess
          ? `<div class="mb-4 p-3 rounded-lg bg-green-500/10 border border-green-500/30 text-green-400 text-sm text-center">
        ...
        <div class="text-center mt-5">
          <a href="/forgot-password"
             class="text-subtle text-sm hover:text-gold transition-colors">
      ...
      <div class="mt-6 text-center">
        <a href="/" class="text-subtle text-sm hover:text-muted transition-colors">
          🌐 Lookup Khatta Record →
        </a>
      </div>
    </div>
